...
\phantomsection
\begin{center}
  {\bf\Huge Conference Committees}
  \bigskip
\end{center}
]
\addcontentsline{toc}{section}{Conference Committees}

{\setlength{\parskip}{0pt}
\titleformat{\subsection}[block]
{\vspace{-8pt}\titlerule\addvspace{1pt}\normalfont\fontsize{10}{16}\bfseries}
...
\subsection*{Statathon Committee}

HaiYing Wang (Chair), University of Connecticut

Tyler Kleykamp, Connecticut Office of Policy and Management
...
\subsection*{Student Paper Committee}
Yuping Zhang (Co-Chair), University of Connecticut

Beatriz (Stefa) Ethcegaray Garcia (Co-Chair), IBM Watson Research Center
...
\item
  ...
  % (Travelers Stat-a-thon; Liberty Mutual Student Poster; IBM Student Paper)
\end{itemize}
\end{large}
...
\phantomsection
\addcontentsline{toc}{section}{2020 New England Statistics Symposium}
