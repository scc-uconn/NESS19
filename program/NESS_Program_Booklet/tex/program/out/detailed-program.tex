...
\phantomsection \subsection*{Parallel Sessions: May 16, 11:00-12:40}
\addcontentsline{toc}{subsection}{Parallel Sessions: May 16, 11:00-12:40}

\phantomsection \vbox{\emph{Location: Saratoga A} \\ \subsubsection*{1. New Advances in Network Data Analysis}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Salon C} \\ \subsubsection*{2. Mathematical Finance}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Nathan Hale South} \\ \subsubsection*{3. Topics in Correlated and Clustered Data}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Colt Boardroom} \\ \subsubsection*{4. Recent Advances in Design of Experiment}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Mark Twain} \\ \subsubsection*{5. Statistical Methods for Big Data in Neuroscience}}
...
\item [\emph{Chair:}] \textbf{Jon Steingrimsson},  Brown University
\end{enumerate}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Wadsworth} \\ \subsubsection*{6. High Dimensional Dependent Data Analysis}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Nathan Hale North} \\ \subsubsection*{7. Causality, Inference, and Applications}}
\addcontentsline{toc}{subsubsection}{Causality, Inference, and Applications}

\begin{enumerate}[align=left]
\item [\emph{Organizer:}] \textbf{Tamara Broderick}, MIT
\item [\emph{Chair:}] \textbf{Sameer Despande},  MIT
\end{enumerate}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Silas Deane} \\ \subsubsection*{8. Teaching Data Science}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Salon A} \\ \subsubsection*{9. Using Statistics for Health Delivery System Reform in Massachusetts}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Salon B} \\ \subsubsection*{10. Biomedical Data Science: To Infinity and Beyond!}}
...
\phantomsection \subsection*{Parallel Sessions: May 16, 14:00-15:40}
\addcontentsline{toc}{subsection}{Parallel Sessions: May 16, 14:00-15:40}

\phantomsection \vbox{\emph{Location: Nathan Hale North} \\ \subsubsection*{11. High Dimensional Econometrics}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Silas Deane} \\ \subsubsection*{12. Advances in Network and Algorithm Analysis}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Salon A} \\ \subsubsection*{13. Data Science in Actuarial Science}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Salon C} \\ \subsubsection*{14. Recent Advances and Applications of Measurement Error Models}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Colt Boardroom} \\ \subsubsection*{15. Recent Advances in Time Series Analysis and Diffusion Processes}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Wadsworth} \\ \subsubsection*{16. Modern Statistical Methods for Health Outcome Data}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Mark Twain} \\ \subsubsection*{17. Data Science and Statistics in Insurance}}
...
\item \textbf{Gao Niu}, Bryant University \\
Image Process Algorithm for Post-Hurricane Damage Estimation
\end{itemize}

\phantomsection \vspace{16pt}\vbox{\emph{Location: Nathan Hale South} \\ \subsubsection*{18. Healthcare Data Analysis for Electronic \\ Health Records}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Salon B} \\ \subsubsection*{19. Causal Identification and Models for Time-Varying Interventions}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Saratoga A} \\ \subsubsection*{20. Predictive Modeling in Data Science: Methods and Applications}}
...
\phantomsection \subsection*{Parallel Sessions: May 16, 16:00-17:40}
\addcontentsline{toc}{subsection}{Parallel Sessions: May 16, 16:00-17:40}

\phantomsection \vbox{\emph{Location: Colt Boardroom} \\ \subsubsection*{21. Frontiers in Sequential Analysis with Applications}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Ethan Allen} \\ \subsubsection*{22. Career Opportunities in Statistics and Data Sciences}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Nathan Hale North} \\ \subsubsection*{23. New Perspectives in Statistical Inference for Data with High Dimensionality}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Silas Deane} \\ \subsubsection*{24. Some Applications of Statistics in Data Science}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Salon A} \\ \subsubsection*{25. Statistical Methodology for Healthcare Data Analysis}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Nathan Hale South} \\ \subsubsection*{26. New Developments of Several Classical Statistical Methods}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Mark Twain} \\ \subsubsection*{27. Estimating and Hypothesis Testing in Time Series and Spatial Models}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Saratoga A} \\ \subsubsection*{28. Bayesian Method and Causal Inference}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Salon C} \\ \subsubsection*{29. Critical Questions in Drug Development}}
...
\emph{Discussant:} \textbf{Joseph C. Cappelleri}, Pfizer

\phantomsection \vspace{16pt}\vbox{\emph{Location: Wadsworth} \\ \subsubsection*{30. New Developments on Data Compatibility and Related  Topics}}
...
\phantomsection \subsection*{Parallel Sessions: May 17, 08:30-10:10}
\addcontentsline{toc}{subsection}{Parallel Sessions: May 17, 08:30-10:10}

\phantomsection \vbox{\emph{Location: Mark Twain} \\ \subsubsection*{31. Computationally Efficient Statistical Methods for Inference on Data with Complex Structures}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Colt Boardroom} \\ \subsubsection*{32. Flexible Modeling of Censored Data}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Nathan Hale South} \\ \subsubsection*{33. Bayesian Methods and Applications}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Silas Deane} \\ \subsubsection*{34. Recent Advances in Statistical Methods for Missing or Truncated Data}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Saratoga A} \\ \subsubsection*{35. Novel Statistical Methods for the Analysis of Genomic Data}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Ethan Allen} \\ \subsubsection*{36. Effective Communication of Technical Concepts to Non-Technical Audiences}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Salon C} \\ \subsubsection*{37. Application of Statistics and Data Sciences in Pharmaceutical Research and Development}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Nathan Hale North} \\ \subsubsection*{38. High-Dimensional Statistical Inference and Learning}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Wadsworth} \\ \subsubsection*{39. Data Science: Computational Social Science?}}
...
\emph{Discussant:} \textbf{Ummugul Bezirhan}, Columbia University, ub2126@columbia.edu

\phantomsection \vspace{16pt}\vbox{\emph{Location: Salon B} \\ \subsubsection*{40. Advancement in the Marked-Point Process Modeling Framework for Real-Time Neural Data Analysis}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Salon A} \\ \subsubsection*{41. Statistical Learning Methods and Developments}}
...
\item [\emph{Chair:}] \textbf{Yan Zhuang},  Connecticut College
\end{enumerate}
...
\phantomsection \subsection*{Parallel Sessions: May 17, 10:30-12:10}
\addcontentsline{toc}{subsection}{Parallel Sessions: May 17, 10:30-12:10}

\phantomsection \vbox{\emph{Location: Saratoga A} \\ \subsubsection*{42. Statistical and Machine Learning Methods for Large-Scale Biomedical Data Analysis}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Silas Deane} \\ \subsubsection*{43. Applications of Network Science and Causal Inference Methods in Public Health Data}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Mark Twain} \\ \subsubsection*{44. Novel Computational Approaches for Analyzing Time Series}}
...
\item [\emph{Chair:}] \textbf{Dipak Dey},  University of Connecticut
\end{enumerate}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Colt Boardroom} \\ \subsubsection*{45. Manifolds and Anomalies for Data Science}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Salon B} \\ \subsubsection*{46. Advances in Modeling and Computation for Latent Variable Models}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Wadsworth} \\ \subsubsection*{47. Air Pollution and Public Health: New Spatial and Spatio-Temporal Statistical Approaches for Exposure Assessment and Causal Inference}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Salon A} \\ \subsubsection*{48. Sports Analytics}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Salon C} \\ \subsubsection*{49. Statistical Learning}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Ethan Allen} \\ \subsubsection*{50. The Role and Advances of Principled Statistical Inference in the Era of Data Science}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Nathan Hale North} \\ \subsubsection*{51. Inference Informed by Structure}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Nathan Hale South} \\ \subsubsection*{52. Recent Advances in High Dimensional Data Analysis}}
\addcontentsline{toc}{subsubsection}{Recent Advances in High Dimensional Data Analysis}

\begin{enumerate}[align=left]
\item [\emph{Organizer:}] \textbf{Tamara Broderick}, MIT
\item [\emph{Chair:}] \textbf{Victor Pena},  Baruch College (CUNY)
\end{enumerate}
...
\phantomsection \subsection*{Parallel Sessions: May 17, 13:10-14:50}
\addcontentsline{toc}{subsection}{Parallel Sessions: May 17, 13:10-14:50}

\phantomsection \vbox{\emph{Location: Ethan Allen} \\ \subsubsection*{53. Probability, Statistics and Geometry: A Special Session Honoring Rick Vitale}}
\addcontentsline{toc}{subsubsection}{Probability, Statistics and Geometry: A Special Session Honoring Rick Vitale}

\begin{enumerate}[align=left]
\item [\emph{Organizer:}] \textbf{Jun Yan}, University of Connecticut
\item [\emph{Chair:}] \textbf{David Pollard},  Yale University
\end{enumerate}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Nathan Hale South} \\ \subsubsection*{54. Novel Methodology and Application of Machine Learning Techniques in Data Science}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Wadsworth} \\ \subsubsection*{55. Statistical Tools for Addressing the Opioid Epidemic}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Salon B} \\ \subsubsection*{56. Challenges and New Advances in Complex Clinical Trials}}
...
\item [\emph{Chair:}] \textbf{Yishu Xue},  University of Connecticut
\end{enumerate}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Salon C} \\ \subsubsection*{57. Data Science in Action at IBM Chief Analytics Office}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Silas Deane} \\ \subsubsection*{58. Some Applications of Data Science in Industry}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Mark Twain} \\ \subsubsection*{59. Novel Statistical Methods for Data Science: Discrete Data, Time Series and Data Integration}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Colt Boardroom} \\ \subsubsection*{60. Statistical Advances in Microbiome Data Analysis}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Nathan Hale North} \\ \subsubsection*{61. Robust Statistics for Data Science}}
...
\item [\emph{Chair:}] \textbf{Rongning Wu},  Baruch College (CUNY)
\end{enumerate}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Salon A} \\ \subsubsection*{62. NESS Leadership Forum for Statistics/Data Science Professionals}}
...
\phantomsection \vspace{16pt}\vbox{\emph{Location: Saratoga A} \\ \subsubsection*{63. Spatial Data Analysis and Text Data Analysis}}
